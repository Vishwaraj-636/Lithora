         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 h-14 flex items-center justify-between">
            ...
            {!user ? (
               ...
               <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <button onClick={handleLogout} className="px-3 sm:px-4 py-1.5 rounded-lg bg-[#000000] text-white text-[12px] sm:text-[13px] font-semibold hover:bg-white hover:text-black border-2 transition-colors cursor-pointer">Logout</button>
               </div>
            )}
         </div>
      </nav>
