...
const EmptyBoxIcon = () => (
  ...
  >
    <rect x="8" y="24" width="48" height="32" rx="4" stroke="#3a322c" strokeWidth="2" />
    <path d="M8 28l24-16 24 16" stroke="#3a322c" strokeWidth="2" strokeLinejoin="round" />
    <path d="M22 28l10-7 10 7" stroke="#b58a5a" strokeWidth="2" strokeLinejoin="round" />
    <path d="M22 36h20" stroke="#3a322c" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6">
            <div className="bg-[#211f1b] border border-[#3a322c] rounded-xl px-5 py-3.5 flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#2e2820] flex items-center justify-center">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#b58a5a" strokeWidth="2" strokeLinecap="round">
                  <path d="M20 7H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z" />
                  <polyline points="16 3 12 7 8 3" />
                </svg>
              </div>
              <div>
                <p className="text-[10px] text-[#a9a49b] uppercase tracking-wide font-semibold">Total Products</p>
                <p className="text-[20px] font-bold text-[#f2ede6] leading-none mt-0.5">{totalProducts}</p>
              </div>
            </div>
          </div>
        </div>
