      ...
      return (
         ...
         >
            <div className="text-center">
               ...
               <h2 className="text-[20px] font-semibold text-[#f2ede6]">
                  Product not found
               </h2>
                ...
                "
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-3">
                     {[
                        ...
                        >
                           ...
                           <span className="text-[9px] sm:text-[10px] text-[#a9a49b] font-medium leading-tight">
                              {label}
                           </span>
                        </div>
                     ))}
                  ...
                  <div className="pt-1 border-t border-[#2e2a25]">
                     <p className="text-[10px] sm:text-[11px] text-[#5a5048] break-all">
                        Product ID:{" "}
                        <span className="text-[#7a6f65]">{product._id}</span>
                     </p>
                  </div>
               </div>
            </div>
