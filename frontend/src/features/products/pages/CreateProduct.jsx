...
const SectionHeading = ({ children }) => (
   <h2 className="text-[10px] sm:text-[11px] tracking-[0.08em] uppercase font-semibold text-[#a9a49b] mb-4 sm:mb-5">
      {children}
   </h2>
);
         ...
         <div className="w-full max-w-300 mx-auto px-4 sm:px-8 lg:px-16 py-8 sm:py-12">
            ...
            <div className="mb-8 sm:mb-10">
               <p className="text-[10px] sm:text-[11px] tracking-[0.08em] uppercase text-[#a9a49b] font-semibold mb-3">
                  ...
                  <span className="text-[#f2ede6]">Create New Product</span>
               </p>
               <h1 className="text-[24px] sm:text-[28px] lg:text-[32px] font-medium text-[#f2ede6] leading-tight mb-5 sm:mb-6">
                  Create New Product
               </h1>
            ...
            <form onSubmit={handleSubmit}>
               <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start">
                     ...
                     <div className="bg-[#211f1b] border border-[#3a322c] rounded-xl p-5 sm:p-7">
                        ...
                        <div className="flex flex-col gap-5">
                           ...
                           <Field label="Description" htmlFor="description">
                              ...
                              />
                              <p className="text-right text-[11px] text-[#a9a49b]">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                           <Field label="Currency" htmlFor="priceCurrency">
                              <div className="relative sm:w-36">
                                 ...
                                 <span className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[#a9a49b]">
                                    <ChevronDown />
                                 </span>
                              </div>
                           </Field>
                  ...
                  <div className="lg:col-span-7">
                    ...
                    `}
                           >
                              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#2e2820] flex items-center justify-center mb-2 sm:mb-3">
                                 <UploadIcon />
                              </div>
                        ...
                        >
                           {images.map((img, idx) => (
                              <div key={idx} className="relative group aspect-square">
                                 ...
                                 />
                                 {idx === 0 && (
                                    <span className="absolute bottom-1 left-1 text-[8px] bg-[#b58a5a] text-white rounded px-1 py-0.5 font-bold leading-none tracking-wide">
                                       COVER
                                    </span>
                                 )}
                                 <button
               ...
               <div className="flex flex-col-reverse sm:flex-row justify-between items-stretch sm:items-center gap-3 mt-6 pt-6 border-t border-[#3a322c] pb-10">
                  ...
                  <button
                     type="submit"
                     className="w-full sm:w-auto px-8 py-2.5 rounded-lg bg-[#b58a5a] text-white text-[13px] sm:text-[14px] font-semibold hover:bg-[#c49a68] transition-colors active:scale-[0.98]"
                  >
                     Create Product
                  </button>
               </div>
